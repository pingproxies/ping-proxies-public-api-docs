...
The Log Summary object represents aggregated usage data for proxies in the Byteful system. It provides a consolidated view of proxy usage patterns over time, offering insights into bandwidth consumption, request counts, and more, without the granularity of individual log entries.
...
- Log Summaries and Residential Ledger track related data but serve different purposes:

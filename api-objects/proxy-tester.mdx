...
| `proxy_test_result_is_successful` | boolean | Whether the test was successful |
| `proxy_test_result_error_code` | integer | Error code that was returned |
| `proxy_test_result_error_source` | integer | State at which the error was returned |

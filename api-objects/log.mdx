---
title: 'Log'
description: 'Understanding the Log object and its role in the Ping Proxies API'
---
...
Logs serve as the primary data source for:
...
When analyzing long-term trends, the system automatically combines data from both logs and log summaries to provide comprehensive analytics, regardless of the age of the data.
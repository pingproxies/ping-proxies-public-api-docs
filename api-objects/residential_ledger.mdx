...
description: 'Understanding the Residential Ledger object and its role in the Ping Proxies API'
---
...
| `service_purchase` | Increments from new residential service purchases |

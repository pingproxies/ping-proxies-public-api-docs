---
title: 'API Structure'
description: 'Understanding the Ping Proxies API structure, URL patterns, HTTP methods, and data formats'
---
...
```
https://staging.api.pingproxies.com/1.0/
```
...
| 422 | Unprocessable Entity | Valid request but operation failed |
...
All date and time values in the API use the ISO 8601 format:
...
- Complete ISO 8601 format: `2023-09-15T14:30:00Z`

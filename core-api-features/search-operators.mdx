...
| `exists_` | Checks Metadata key existence check | `proxy_user_metadata.exists_client_id=1` |
...
Dates and times use 20XX-01-31 format and work with `min_` and `max_` operators:

...
```
socks5h://your_user_c_us_s_ABCDEFGHIJKLMNO:your_password@mobile.pingproxies.com:8000
socks5h://your_user_c_us_s_PQRSTUVWXYZ1234:your_password@mobile.pingproxies.com:8000
```

## Important Notes

- Unlike datacenter and ISP proxies, mobile proxies are generated on-demand
- The proxy user must have sufficient mobile bandwidth allocation
- Every request for mobile proxies consumes a small amount of bandwidth

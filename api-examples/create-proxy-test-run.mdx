...
def create_bulk_proxy_test(
    proxy_strings, test_server_id, target_url="https://pingproxies.com"
):
    """
...
class ProxyTester {
    ...
    public function __construct($publicKey, $privateKey) {
        ...
        $this->baseUrl = "https://api.pingproxies.com/1.0/public/user";
        $this->headers = [
...
- **is_successful**: Whether the proxy test completed successfuly

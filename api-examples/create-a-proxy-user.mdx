---
title: "Create a proxy user with metadata and bandwidth limits"
description: "Learn how to create a proxy user with custom metadata and bandwidth allocation"
icon: "user-plus"
---

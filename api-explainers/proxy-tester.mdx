...
```mermaid
graph TD
    A["Create Proxy Test Run<br/><small>[POST] /public/proxy_test_run/create</small>"]:::userAction
    ...
    D --> E["Retrieve Proxy Test Results (optional)<br/><small>[GET] /public/proxy_test_run/retrieve/</small>"]:::userAction

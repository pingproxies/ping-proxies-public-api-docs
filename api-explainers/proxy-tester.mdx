...
description: 'This guide explains how proxy testing works on the Ping Proxies API.'
---
...
```mermaid
graph TD
    A["Create Proxy Test Run<br/><small>[POST] /public/proxy_tester/proxy_test_run/create</small>"]:::userAction
    ...
    D --> E["Retrieve Proxy Test Results (optional)<br/><small>[GET] /public/proxy_tester/proxy_test_run/retrieve/</small>"]:::userAction

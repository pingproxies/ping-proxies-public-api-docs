...
description: 'Understanding and managing residential bandwidth allocation in the Byteful API'
---

Unlike datacenter and ISP proxies that operate on a per-proxy model, residential proxies use a bandwidth-based allocation system. This guide explains how residential bandwidth is managed in the Byteful API.

## Bandwidth Fundamentals

Residential bandwidth in Byteful works as follows:

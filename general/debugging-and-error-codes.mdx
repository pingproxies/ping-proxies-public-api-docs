...
We also expose a single HTTP-style error code `301`, returned only when you try to reach a HTTP target on our residential/mobile network, which only allows HTTPS targets.
...
|  **4000**   | **Tunnel closed improperly but is most likely still a successful proxy attempt** |
...
|    2000         | Internal server error ocurred |
...
|    3100 - 3200         | Could not to establish connection to target |
|    3400 - 3500 | Could not find residential/mobile node with given routing parameters |
|    4001 - 4102  | Internal server error occurred |
|    4103         | Connection was unused for too long (5 minutes+) |
| 9100 - 9104     | Connection closed early |
...
|    9301         | Connection was used for too long (24 hours+) |
|    9302         | Handshake took too long to complete (30 secs+) |

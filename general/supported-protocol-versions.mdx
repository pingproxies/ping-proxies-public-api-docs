...
### Residential
<Note>
For security reasons on our residential network, unencrypted HTTP connections are only supported to `ip-api.com`. For all other destinations you must use HTTPS (port 443). If you need HTTP access to additional targets, please contact support@pingproxies.com.
</Note>
...
### Mobile
<Note>
For security reasons on our mobile network, unencrypted HTTP connections are only supported to `ip-api.com`. For all other destinations you must use HTTPS (port 443). If you need HTTP access to additional targets, please contact support@pingproxies.com.
</Note>

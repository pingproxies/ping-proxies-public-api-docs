...
description: "Learn how to update the email address associated with your Ping Proxies account"
---
...
1. Enter a new email address and click **Save Changes**. It can not be linked to any other Ping Proxies accounts.

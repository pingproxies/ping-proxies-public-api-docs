...
<Note>
All Python examples rely upon libraries and their implict behaviours to send specific types of requests (CONNECT vs MITM-style). All Rust examples are much more explicit and show exactly how the mechanisms of proxying work.
</Note>

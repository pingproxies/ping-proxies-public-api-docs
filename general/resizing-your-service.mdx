...
description: 'Learn how to resize and reconfigure your Ping Proxies services'
---
...
![Service options menu](/images/general/service-options-menu.png)
...
![Service reconfiguration options](/images/general/service-reconfiguration-options.png)
...
If you're happy with the change then you can click confirm and you'll reconfiguration will be instantly processed. If you've added new IPs then they'll be delivered within a few moments by our system and you'll get an email confirmation of the change.

![Service reconfiguration review](/images/general/service-reconfiguration-review.png)

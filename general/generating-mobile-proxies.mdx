...
If you have available mobile bandwidth on your account you can generate mobile proxies on the Mobile Generator dashboard section.
...
<img
  ...
  alt="Ping Proxies Mobile Proxies Generator"
/>
...
**Format**
```
mobile.pingproxies.com:8000:{username}:{password}
```

**Example**
```
mobile.pingproxies.com:8000:stevejobs:apple123
```
...
**Format**
```
mobile.pingproxies.com:8000:{username}_s_{random_alphanumeric}:{password}
```

**Example of a Sticky Proxy**
```
mobile.pingproxies.com:8000:stevejobs_s_we12NkllMSS:apple123
```
...
**Format**
```
mobile.pingproxies.com:8000:{username}_s_{random_alphanumeric}_ttl_{number}{unit}:{password}
```

**Examples of Session TTL Proxy**
```
mobile.pingproxies.com:8000:stevejobs_s_we12NkllMSS_ttl_30m:apple123
mobile.pingproxies.com:8000:stevejobs_s_we12NkllMSS_ttl_2h:apple123
mobile.pingproxies.com:8000:stevejobs_s_we12NkllMSS_ttl_1d:apple123
```
...
[Smartpath®](/general/using-smartpath-mobile) is an intelligent, AI-driven proxy routing feature designed to optimize your mobile proxy bandwidth usage by dynamically routing traffic through mobile or datacenter IPs.
...
**Format**
```
mobile.pingproxies.com:8000:{username}_smartpath:{password}
```

**Example of a Smartpath Proxy**
```
mobile.pingproxies.com:8000:stevejobs_smartpath:apple123
```
...
**Format**
```
mobile.pingproxies.com:8000:{username}_c_{country_iso_code}:{password}
```

**Example of a United Kingdom Proxy**
```
mobile.pingproxies.com:8000:stevejobs_c_gb:apple123
```
### State Targeting
...
**Format**
```
mobile.pingproxies.com:8000:{username}_c_us_state_{state_name}:{password}
```

**Example of a Florida Proxy**
```
mobile.pingproxies.com:8000:stevejobs_c_us_state_florida:apple123
```
...
**Format**
```
mobile.pingproxies.com:8000:{username}_c_{country_iso_code_of_city}_city_{city_alias}:{password}
```

**Example of a London Proxy**
```
mobile.pingproxies.com:8000:stevejobs_c_gb_city_london:apple123
```
### Zip Code Targeting
...
**Format**
```
mobile.pingproxies.com:8000:{username}_c_{country_iso_code_of_zip_code}_zip_{zip_code_id}:{password}
```

**Example of a ZIP Code 32808 Proxy**
```
mobile.pingproxies.com:8000:stevejobs_c_us_zip_32808:apple123
```
...
**Format**
```
mobile.pingproxies.com:8000:{username}_asn_{asn_number}:{password}
```

**Example of a AT&T Proxy**
```
mobile.pingproxies.com:8000:stevejobs_asn_7018:apple123
```
...
```
mobile.pingproxies.com:8000:stevejobs_c_us_city_charlotte_asn_7018:apple123
```

**Example of a Sticky AT&T Proxy in Charlotte, NC USA**
```
mobile.pingproxies.com:8000:stevejobs_c_us_city_charlotte_asn_7018_s_h12kJsas129:apple123
```

**Example of a Sticky United Kingdom Proxy**
```
mobile.pingproxies.com:8000:stevejobs_c_gb_s_dvnwcNOod12312s:apple123
```

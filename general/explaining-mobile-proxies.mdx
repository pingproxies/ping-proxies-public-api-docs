...
description: 'Learn about mobile proxies, their benefits, and how they work at Ping Proxies'
---
<img
  src="/images/general/mobile-proxies.png"
  alt="Ping Proxies Mobile Proxies"
/>
...
Mobile proxies at Ping Proxies use a **Pay per GB model**. Charges are based on the amount of data (bandwidth) transferred through the proxy service.
...
Yes! We have no limitations on proxies or concurrency with our mobile bandwidth packages since they're charged per GB.
...
We support over 195 countries and every major city in the world on all mobile bandwidth plans. After purchase, you can select the country or city you'd like to geolocate your proxies to.

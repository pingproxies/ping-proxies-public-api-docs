...
**Date, time, and timezone of the incident** [REQUIRED]
**Source IP address(es) involved in the abusive activity** [REQUIRED]
**Type of abuse (see categories below)** [REQUIRED]
**Your contact information for follow-up** [REQUIRED]
Full email headers (for spam/phishing) [OPTIONAL]
Server or firewall logs showing the abusive activity [OPTIONAL]
Relevant URLs or domains involved [OPTIONAL]
Screenshots, packet captures, or other technical evidence [OPTIONAL]

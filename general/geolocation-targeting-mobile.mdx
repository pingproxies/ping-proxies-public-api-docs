...
Country and city geolocation targeting comes as standard with all mobile bandwidth purchases. We support over 195 countries and every major city in the world.
...
curl --request GET \
  --url 'https://api.pingproxies.com/1.0/public/user/mobile/list?country_id=us&list_count=5' \
...
{
  "data": [
    "socks5h://your_user_c_us_s_DDINPY7TQ0781XEO:your_password@mobile.pingproxies.com:8000",
    "socks5h://your_user_c_us_s_XIINPY7TQ0781XEA:your_password@mobile.pingproxies.com:8000",
    "socks5h://your_user_c_us_s_PPINPY7TQ0781XEB:your_password@mobile.pingproxies.com:8000",
    "socks5h://your_user_c_us_s_QQINPY7TQ0781XEC:your_password@mobile.pingproxies.com:8000",
    "socks5h://your_user_c_us_s_RRINPY7TQ0781XED:your_password@mobile.pingproxies.com:8000"
  ],
...
curl --request GET \
  --url 'https://api.pingproxies.com/1.0/public/user/mobile/list?country_id=gb&city_alias=london&list_count=3' \
  --header 'X-API-Public-Key: your_public_key' \
  --header 'X-API-Private-Key: your_private_key'
```
...
{
  "data": [
    "socks5h://your_user_c_gb_city_london_s_DDINPY7TQ0781XEO:your_password@mobile.pingproxies.com:8000",
    "socks5h://your_user_c_gb_city_london_s_XIINPY7TQ0781XEA:your_password@mobile.pingproxies.com:8000",
    "socks5h://your_user_c_gb_city_london_s_PPINPY7TQ0781XEB:your_password@mobile.pingproxies.com:8000"
  ],
  "message": "Mobile list successfully created."
}
```
...
curl --request GET \
  --url 'https://api.pingproxies.com/1.0/public/user/mobile/list?country_id=us&subdivision_id=us-ca&list_count=3' \
  --header 'X-API-Public-Key: your_public_key' \
  --header 'X-API-Private-Key: your_private_key'
```
...
curl --request GET \
  --url 'https://api.pingproxies.com/1.0/public/user/mobile/list?country_id=us&asn_id=7018&list_count=3' \
  --header 'X-API-Public-Key: your_public_key' \
  --header 'X-API-Private-Key: your_private_key'
```

...
|-----------|------------|
| Proxy User Password | 8-32 Alphanumeric |
...
3. Click the "Edit Authentication" button next to their name to alter the password or IP authentication, or "Edit Limits" to adjust the residential pool allowance and other service access.
...
<img
  ...
  alt="Ping Proxies Proxy User Limits"
/>

### Residential Bandwidth Allocation

You can edit the proxy user's residential pool allowance clicking Edit Limits next to the proxy user on the dashboard.

...
description: 'Understanding domain restrictions in the Ping Proxies network'
---

# Restricted Domains

Ping Proxies maintains a comprehensive list of restricted domains to ensure network security, prevent abuse, and maintain compliance with regulations.
...
<Note>
  If you need to access the full up-to-date list of restricted domains, please contact [support@pingproxies.com](mailto:support@pingproxies.com).
</Note>
...
1. Contact our support team at [support@pingproxies.com](mailto:support@pingproxies.com)
...
- Contact [support@pingproxies.com](mailto:support@pingproxies.com) for specific inquiries
